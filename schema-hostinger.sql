-- Agency OS — Hostinger Import Schema
-- Import this file via phpMyAdmin into your existing database (u426438866_agency_os)
-- Do NOT run CREATE DATABASE — the database already exists on Hostinger.
