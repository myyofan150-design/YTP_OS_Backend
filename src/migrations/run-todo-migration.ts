// src/migrations/run-todo-migration.ts
// Run: npx ts-node src/migrations/run-todo-migration.ts
...
async function runMigration() {
  const sqlPath = path.join(__dirname, "todo_module.sql");
  ...
  console.log(`\n📦 Running todo_module.sql — ${statements.length} statements\n`);
